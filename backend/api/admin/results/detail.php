<?php
/**
 * GET /backend/api/admin/results/detail.php?attempt_id=
 * Admin review of any student's submitted attempt.
 */
...
try {
    $stmt = db()->prepare(
        'SELECT a.id, a.score, a.submitted_at, a.status, a.exam_id, a.student_id,
                e.title, e.subject_code, e.total_marks,
                u.name AS student_name, u.roll_or_id, u.email
    ...
    if ($attempt['status'] !== 'submitted') {
        jsonError('This attempt has not been submitted yet.', 403);
    }
