-- ExamPortal — tables only (for Railway / Aiven / cloud MySQL)
-- Select your database in the SQL console first, then run this file.
-- Do NOT run CREATE DATABASE here — the host already provides a DB name.
